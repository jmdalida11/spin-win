        ...
        if (players.length > 0) {
          const newWinners = [
            ...winners,
            {
              ...
              prize: isInputPrize ? inputPrize : prize,
            },
          ];
      ...
      <Right>
        <div>
          ...
          <span style={{ marginLeft: 20 }}>
            ...
            <input
              type="checkbox"
              checked={isInputPrize}
              onChange={() => setIsInputPrize((prev) => !prev)}
            />
            {isInputPrize && (
              <input
                value={inputPrize}
        ...
        <div>
          ...
          >
            <span>Winners:</span>
            <span>
              <button onClick={clearAllWinners}>Clear all winners</button>
            </span>
          </h4>
          <div>
            {winners.map((w, idx) => (
